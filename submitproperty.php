...
<body>
    ...
    if (!isset($_SESSION['_id'])) {
        ...
        if (isset($_GET['ref']) && isset($_GET['id'])) {
            if ($_GET['ref'] == 'update') {
                $method = $_GET['ref'];
                $id = $_GET['id'] ?? null;
                $url = 'admin/submit-property.php?ref=' . $method . '&id=' . $id;
            } else {
                $id = null;
                $url = 'admin/submit-property.php';
            }
        } else {
            $id = null;
            $url = 'admin/submit-property.php';
    ...
    <div class="summit-section">
        <form id="submitForm" method="POST" action="admin/submit-property.php" enctype="multipart/form-data">
            <div class="container">
                <div class="container">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            if (urlParams.has('id')) {
                $.ajax({
                    url: 'admin/get-property.php?id=<?php echo $id; ?>',
                    type: 'GET',
                    dataType: 'json',
                    success: function(response) {
                        console.log(response);
